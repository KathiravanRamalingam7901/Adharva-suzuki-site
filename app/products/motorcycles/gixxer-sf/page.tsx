...
export default function GixxerSFPage() {
    ...
    <div className="min-h-screen pt-24 bg-white text-slate-900">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          >
            Gixxer / <span className="text-suzuki-red">Gixxer SF</span>
          </motion.h1>
          <motion.p
          ...
          >
            A perfect blend of sporty performance and everyday usability. The GIXXER SF is designed to thrill with its aerodynamic design and powerful engine.
          </motion.p>
          ...
          >
            ...
            <a
              href="https://www.adharvaasuzuki.com/_files/ugd/703249_c6f175d722b9485d85244d1408dc8388.pdf"
              target="_blank"
            ...
            >
              ...
              <motion.div
                ...
                animate={{
                  backgroundColor: selectedColor.name.includes('Orange') ? '#F97316' :
                    selectedColor.name.includes('Blue') ? '#1E40AF' : '#1E293B'
                }}
              ...
              >
                ...
                <div className="hidden lg:block absolute inset-0 pointer-events-none">
                  {[
                    { label: "Full LED Headlamp", x: "25%", y: "40%" },
                    { label: "Fuel Injection", x: "60%", y: "45%" },
                    { label: "Single Channel ABS", x: "75%", y: "70%" },
                    { label: "Aerodynamic Design", x: "15%", y: "30%" }
                  ].map((feature, i) => (
                    <motion.div
                      key={i}
          ...
          >
            ...
            >
              ...
              <motion.p
                ...
                transition={{ delay: 0.2 }}
              >
                Sporty and agile naked sports bike. Ideal for city commuting and weekend rides with style and performance.
              </motion.p>
