    ...
    <div className="min-h-screen pt-24 bg-white text-slate-900">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          >
            Gixxer SF 250 / <span className="text-suzuki-red">Gixxer 250</span>
          </motion.h1>
          <motion.p
            className="text-base sm:text-lg md:text-xl text-slate-700 max-w-3xl leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.4, duration: 0.6 }}
          >
            Unleash the racer within with the GIXXER SF 250. Engineered for high-speed performance and precision handling, it's the ultimate quarter-liter sportbike.
          </motion.p>
          ...
          >
            ...
            <a
              href="https://www.adharvaasuzuki.com/_files/ugd/703249_5f82baa6c5f54cf7b4af3859749f9e0f.pdf"
              target="_blank"
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                animate={{
                  backgroundColor: selectedColor.name.includes('Blue') ? '#1E40AF' : '#1E293B'
                }}
              ...
              >
                ...
                <div className="hidden lg:block absolute inset-0 pointer-events-none">
                  {[
                    { label: "SOCS Technology", x: "60%", y: "40%" },
                    { label: "Dual Channel ABS", x: "75%", y: "75%" },
                    { label: "Twin Exhaust Muffler", x: "80%", y: "60%" },
                    { label: "MotoGP Inspired", x: "20%", y: "30%" }
                  ].map((feature, i) => (
                    <motion.div
                      key={i}
