    ...
    <div className="min-h-screen pt-16 bg-gray-50">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            A trusted and efficient scooter designed for everyday commuting with comfort, reliability, and style.
          </motion.p>
        </div>
      </motion.div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <Image
                    ...
                    alt={`Access 125 ${selectedColor.name}`}
                    fill
