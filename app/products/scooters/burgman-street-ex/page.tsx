    ...
    <div className="min-h-screen pt-20 bg-white text-slate-900">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          >
            Burgman Street <span className="text-suzuki-red">EX</span>
          </motion.h1>
          <motion.p
          ...
          >
            The exclusive Burgman variant with enhanced luxury, advanced tech, and a premium road presence. Elevate your status with the ultimate maxi-scooter experience.
          </motion.p>
          ...
          >
            ...
            <a
              href="https://www.adharvaasuzuki.com/_files/ugd/703249_66127890b8ae4a8c9e35a9b17b0c247d.pdf"
              target="_blank"
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                animate={{
                  backgroundColor: selectedColor.name.includes('Blue') ? '#1E3A8A' : '#1E293B'
                }}
              ...
              >
                ...
                <div className="hidden lg:block absolute inset-0 pointer-events-none">
                  {[
                    { label: "Premium Alpha Engine", x: "60%", y: "65%" },
                    { label: "Engine Stop-Start System", x: "75%", y: "45%" },
                    { label: "Silent Starter System", x: "50%", y: "75%" },
                    { label: "Exclusive Chrome Detail", x: "20%", y: "40%" }
                  ].map((feature, i) => (
                    <motion.div
                      key={i}
